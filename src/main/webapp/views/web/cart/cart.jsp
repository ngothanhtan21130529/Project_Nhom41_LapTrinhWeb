...
<main class="content">
    ...
    <form action="${pageContext.request.contextPath}/order" method="post">
        <div class="shopping-cart">
            ...
            <c:forEach items="${cart}" var="product">
                <div class="product">
                    ...
                    <div class="product-quantity">
                        <input type="number" value="" min="1" name="quantity">
                    </div>
                    <div class="product-removal">
                        <button class="remove-product">
                            <a href="${pageContext.request.contextPath}/removeproducts?img=${product.imgURL}&id=${product.id}&name=${product.productName}&price=${product.price}">Xóa</a>
                        </button>
                    </div>
                        <%--                <div class="product-line-price">${cart.product.price * cart.quantity}</div>--%>
                </div>
            </c:forEach>
            <%--        <div class="product">--%>
            <%--            <div class="product-image">--%>
            ...
            <%--            </div>--%>
            <%--        </div>--%>
            <button class="checkout"><a href="">Thanh toán</a></button>
        </div>

    ...
    <div class="ui">
        ...
        <div class="content-bar">
            <div class="product-tab">
                <form method="post" action="<%=request.getContextPath()%>/updatingProduct"
                    ...
                    <div class="product-adding-tab content-tab">
                        <div class="product-adding-tab-general-infomation">
                            <input type="hidden" value="${productElement.getId()}" name="product-id">
                            ...
                            <div class="categories-product-input">
                                <select name="category">
                                    <c:forEach items="${categoryNameList}" var="categoryName">
                                        <option value="${categoryName.getId()}">${categoryName.getCategoryName()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="price" value="${productElement.getPrice()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-action-choose">
                                <input type="checkbox" name="sale" ${productElement.getSale()==1?"checked":""}>
                            </div>
                            <div class="product-price-label">
                                <p>
                                    Sản phẩm mới:
                            ...
                            <div class="product-action-choose">
                                <input type="checkbox" name="hot" ${productElement.isHot()==true?"checked":""}>
                            </div>
                            <div class="product-price-label">
                                <p>
                                    Màu sắc:
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="color" value="${productElement.getStoneColor()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="opacity" value="${productElement.getOpacity()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="size" value="${productElement.getSize()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="weight" value="${productElement.getWeight()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="shape" value="${productElement.getCuttingGrindingShape()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="material" value="${productElement.getMaterial()}">
                                </div>
                            </div>
                            <div class="product-price-label">
                                <p>
                            ...
                            <div class="product-price-input-output">
                                <div class="product-price-input">
                                    <input type="text" name="quantity" value="${productElement.getQuantity()}">
                                </div>
                            </div>
                        </div>
                        <div class="product-tab-detail-information">
                            ...
                            <div class="title-input-box">
                                <input type="text" name="name" value="${productElement.getProductName()}">
                            </div>
                            ...
                            <div class="product-description-input">
                                <input type="text" placeholder="Nhập dòng mô tả ngắn sản phẩm, bài viết tại khung này"
                                       name="discription" value="${productElement.getDescription()}">
                            </div>
                            ...
                            <div class="product-description-input">
                                <textarea name="content" cols="30" rows="10"
                                          placeholder="Nhập thông tin sản phẩm chi tiết tại đây" value="${productElement.getDescription()}"></textarea>
                            </div>
                            <div class="product-action-label">
                                Hiển thị:
                            </div>
                            <div class="product-action-choose">
                                <input type="checkbox" name="status" ${productElement.getStatus()==null?"":"checked"}>
                            </div>

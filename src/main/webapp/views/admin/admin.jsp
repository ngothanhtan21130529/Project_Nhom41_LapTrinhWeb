...
<head>
    ...
    <title>Admin</title>
    <link rel="stylesheet" href="css/admin.css?v=111" type="text/css">
    ...
    <link
            ...
            rel="stylesheet">
    <script src="<%=request.getContextPath()%>/js/admin.js?v=2" type="text/javascript">
    </script>
    <%--    jQuerry--%>
    ...
    <%--    JavaScript--%>
    <script src="<%=request.getContextPath()%>/js/adminDataTable.js?v=1"></script>
</head>
<body>
<div class="container">
    <div class="top-bar">

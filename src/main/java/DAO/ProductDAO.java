...
//                int thumbnailID=rs.getInt("thumbnail_id");
//
//                res=new Product(id, categoryId, name, price, status, thumbnailID);
//            }
//
//            MySqlConnection.getConnection().close();
//        } catch (SQLException e) {
...
//                int thumbnailID=rs.getInt("thumbnail_id");
//
//                Product product=new Product(id, categoryId, name, price, status,thumbnailID);
//                res.add(product);
//            }
//
//            MySqlConnection.getConnection().close();
